...
# so output always lands in data/raw/hepsiemlak/ regardless of where you
# run `python scraper_hepsiemlak.py` from.
PROJECT_ROOT = Path(__file__).resolve().parent.parent.parent
OUTPUT_DIR = PROJECT_ROOT / "data" / "raw" / "hepsiemlak"
...
async def main():
    async with async_playwright() as p:
        ...
        if all_data:
            ...
            output_file = OUTPUT_DIR / f"hepsiemlak_listings_{timestamp}.xlsx"
